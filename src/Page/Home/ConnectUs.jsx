...
const ConnectUs = () => {
  return (
    <section className="bg-black text-white pt-16 mt-24 flex justify-center items-center min-h-[580px] relative">
      ...
      <div className="max-w-6xl py-16 flex flex-col justify-between md:flex-row items-center gap-8">
        ...
        {/* Form Section */}
        <div className="md:w-[530px] boxFixed h-auto border border-black bg-white text-black p-6 rounded-lg shadow-lg md:absolute md:left-[55%] md:top-[10%]">
          <h3 className="text-3xl font-bold mt-4 ml-3">Get a Consultation</h3>
          <form className="space-y-5 p-4 border-black">
            <div>
              <label className="block font-medium">Name</label>
              <input type="text" placeholder="Input Name" className="w-full border border-black px-2 py-4 rounded-lg" />
            </div>
            <div>
              <label className="block font-medium">Email</label>
              <input type="email" placeholder="Input Email" className="w-full border border-black px-2 py-4 rounded-lg" />
            </div>
            <div>
              <label className="block font-medium">Message</label>
              <textarea rows='5' placeholder="Input Your Question" className="w-full border-black px-2 py-4 border rounded-lg"></textarea>
            </div>
