  ...
  return (
    <section className="py-12 w-11/12 mx-auto">
      <div className="container mx-auto px-4">
        {/* Title */}
        <h2 className="text-4xl font-extrabold text-center text-gray-800 dark:text-white/80 mb-6">
          About Us
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white dark:bg-neutral-700 rounded-lg shadow-md">
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white dark:bg-neutral-700 dark:text-white/80 rounded-lg shadow-md">
